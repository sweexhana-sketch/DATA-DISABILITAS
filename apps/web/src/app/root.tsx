    ...
    <html lang="en">
      ...
      <body>
        <div className="flex min-h-screen bg-white">
          ...
          <aside className="w-64 border-r border-gray-100 flex flex-col fixed inset-y-0">
            <div className="p-6 flex flex-col items-center border-b border-gray-50">
              <img
                ...
                onError={(e) => { e.currentTarget.src = '/src/__create/favicon.png' }}
              />
              <div className="text-center">
                <h2 className="text-[12px] font-black text-[#2A2E45] leading-tight">DINSOS & PPPA</h2>
                <h2 className="text-[12px] font-black text-[#2A2E45] leading-tight">PAPUA BARAT DAYA</h2>
                <p className="text-[9px] text-[#8A8FA6] mt-1 font-bold uppercase tracking-widest">Sistem Pendataan Disabilitas</p>
              </div>
            </div>
          ...
          {/* Main Content */}
          <main className="flex-1 ml-64 bg-[#F7F9FC]">
            <header className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-10">
              <h1 className="text-lg font-bold text-gray-800">
                {pathname === '/dashboard' || pathname === '/' ? 'Ringkasan Data' :
                  pathname === '/tambah-data' ? 'Pendaftaran Baru' :
                    'Daftar Data'}
              </h1>
              <div className="flex items-center space-x-4">
                <span className="text-xs font-medium text-gray-400">Provinsi Papua Barat Daya</span>
