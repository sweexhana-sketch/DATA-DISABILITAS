...
import { ServerRouter, useMatches, useActionData, useLoaderData, useParams, useNavigate, useLocation, Meta, Links, ScrollRestoration, Scripts, Outlet, useRouteError, useAsyncError } from 'react-router';
import { isbot } from 'isbot';
import { renderToPipeableStream } from 'react-dom/server';
import * as React from 'react';
import { createElement, forwardRef, useEffect, useRef, useState, Component, useCallback } from 'react';
import { useButton } from '@react-aria/button';
import { f as fetchWithHeaders } from './index-rgGHF16Q.js';
...
function AuthErrorPage() {
  return /* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
    ...
    renderId: "render-7491ba91",
    as: "div",
    children: [/* @__PURE__ */ jsx(CreatePolymorphicComponent, {
      renderId: "render-0c36413a",
      as: "h1",
      ...
      renderId: "render-cb402a42",
      as: "p",
      children: "Terjadi kesalahan saat masuk. Silakan coba lagi."
    }), /* @__PURE__ */ jsx(CreatePolymorphicComponent, {
      href: "/account/signin",
      renderId: "render-b5555f01",
      as: "a",
...
function SignInPage() {
  ...
  return /* @__PURE__ */ jsx(CreatePolymorphicComponent, {
    className: "flex min-h-screen w-full items-center justify-center bg-[#F7F9FC]",
    renderId: "render-fffaa247",
    as: "div",
    children: /* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
      noValidate: true,
      onSubmit,
      className: "w-full max-w-md rounded bg-white p-8 border border-[#E4E9F2]",
      renderId: "render-ecf06b03",
      as: "form",
      children: [/* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
        className: "mb-6 text-center",
        renderId: "render-ad75bb17",
        as: "div",
        children: [/* @__PURE__ */ jsx(CreatePolymorphicComponent, {
          className: "flex justify-center mb-6",
          renderId: "render-4b8143b0",
          as: "div",
          children: /* @__PURE__ */ jsx(CreatePolymorphicComponent, {
            src: "/logo-pbd.png",
            alt: "Logo Papua Barat Daya",
            className: "w-24 h-24 object-contain",
            renderId: "render-a3edac77",
            as: "img"
          })
        }), /* @__PURE__ */ jsx(CreatePolymorphicComponent, {
          ...
          renderId: "render-3bfed0a6",
          as: "p",
          children: "DINSOS & PPPA Papua Barat Daya"
        })]
      }), /* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
        className: "space-y-4",
        renderId: "render-566e189b",
        as: "div",
        children: [/* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
          ...
          renderId: "render-254e876f",
          as: "div",
          children: [/* @__PURE__ */ jsx(CreatePolymorphicComponent, {
            className: "block text-sm font-medium text-[#2A2E45] mb-2",
            renderId: "render-9d88142e",
            as: "label",
            children: "Password"
          }), /* @__PURE__ */ jsxs(CreatePolymorphicComponent, {
            className: "relative",
            renderId: "render-33b923b4",
            as: "div",
            children: [/* @__PURE__ */ jsx(CreatePolymorphicComponent, {
              required: true,
              name: "password",
