...
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
        ...
        function normalizeAliases(e3) {
          ...
          for (const e4 in t3) for (const i2 in t3) i2 === e4 || e4.startsWith(i2) || ((_a2 = t3[e4]) == null ? void 0 : _a2.startsWith(i2)) && ct.has(t3[e4][i2.length]) && (t3[e4] = t3[i2] + t3[e4].slice(i2.length));
        ...
        const mt = /* @__PURE__ */ Object.create(null), dist_i = (e3) => {
          var _a2, _b2;
          return ((_a2 = globalThis.process) == null ? void 0 : _a2.env) || ((_b2 = globalThis.Deno) == null ? void 0 : _b2.env.toObject()) || globalThis.__env__ || (e3 ? mt : globalThis);
        }, gt = new Proxy(mt, { get: (e3, t3) => dist_i()[t3] ?? mt[t3], has: (e3, t3) => t3 in dist_i() || t3 in mt, set: (e3, t3, i2) => (dist_i(true)[t3] = i2, true), deleteProperty(e3, t3) {
          if (!t3) return false;
        ...
        const yt = (function() {
          ...
          if ((_a2 = globalThis.process) == null ? void 0 : _a2.env) for (const e3 of vt) {
            const t3 = e3[1] || e3[0];
            if ((_b2 = globalThis.process) == null ? void 0 : _b2.env[t3]) return { name: e3[0].toLowerCase(), ...e3[2] };
          }
          return "/bin/jsh" === ((_d2 = (_c2 = globalThis.process) == null ? void 0 : _c2.env) == null ? void 0 : _d2.SHELL) && ((_f2 = (_e3 = globalThis.process) == null ? void 0 : _e3.versions) == null ? void 0 : _f2.webcontainer) ? { name: "stackblitz", ci: false } : { name: "", ci: false };
        })();
        yt.name;
        function std_env_dist_n(e3) {
          return !!e3 && "false" !== e3;
        }
        const _t = ((_a = globalThis.process) == null ? void 0 : _a.platform) || "", Et = std_env_dist_n(gt.CI) || false !== yt.ci, bt = std_env_dist_n(((_b = globalThis.process) == null ? void 0 : _b.stdout) && ((_c = globalThis.process) == null ? void 0 : _c.stdout.isTTY)), St = (std_env_dist_n(gt.DEBUG), "test" === xt || std_env_dist_n(gt.TEST)), kt = (std_env_dist_n(gt.MINIMAL), /^win/i.test(_t)), wt = (/^linux/i.test(_t), /^darwin/i.test(_t), !std_env_dist_n(gt.NO_COLOR) && (std_env_dist_n(gt.FORCE_COLOR) || (bt || kt) && gt.TERM), (((_e2 = (_d = globalThis.process) == null ? void 0 : _d.versions) == null ? void 0 : _e2.node) || "").replace(/^v/, "") || null), It = (Number(wt == null ? void 0 : wt.split(".")[0]), globalThis.process || /* @__PURE__ */ Object.create(null)), Ct = { versions: {} }, Rt = (new Proxy(It, { get: (e3, t3) => "env" === t3 ? gt : t3 in e3 ? e3[t3] : t3 in Ct ? Ct[t3] : void 0 }), "node" === ((_g = (_f = globalThis.process) == null ? void 0 : _f.release) == null ? void 0 : _g.name)), Pt = !!globalThis.Bun || !!((_i = (_h = globalThis.process) == null ? void 0 : _h.versions) == null ? void 0 : _i.bun), Tt = !!globalThis.Deno, At = !!globalThis.fastly, Nt = [[!!globalThis.Netlify, "netlify"], [!!globalThis.EdgeRuntime, "edge-light"], ["Cloudflare-Workers" === ((_j = globalThis.navigator) == null ? void 0 : _j.userAgent), "workerd"], [At, "fastly"], [Tt, "deno"], [Pt, "bun"], [Rt, "node"]];
        !(function() {
          const e3 = Nt.find((e4) => e4[0]);
          if (e3) e3[1];
        })();
        const Lt = require_node_tty(), Ot = ((_m = (_l = (_k = Lt == null ? void 0 : Lt.WriteStream) == null ? void 0 : _k.prototype) == null ? void 0 : _l.hasColors) == null ? void 0 : _m.call(_l)) ?? false, base_format = (e3, t3) => {
          if (!Ot) return (e4) => e4;
        ...
        function utils_hash(e3, t3 = 8) {
          return ((function() {
            ...
            try {
              return $t = !!((_b2 = (_a2 = ft()).getFips) == null ? void 0 : _b2.call(_a2)), $t;
            } catch {
              return $t = false, $t;
            }
        ...
        function jitiInteropDefault(e3, t3) {
          return e3.opts.interopDefault ? (function(e4) {
            ...
            return new Proxy(e4, { get(t5, s3, a2) {
              ...
              if ("default" === s3) return r2 ? e4 : "function" == typeof (i2 == null ? void 0 : i2.default) && e4.__esModule ? i2.default : i2;
        ...
        function jitiResolve(e3, t3, i2) {
          ...
          let n2 = (i2 == null ? void 0 : i2.parentURL) || e3.url;
          isDir(n2) && (n2 = pathe_M_eThtNZ_join(n2, "_index.js"));
          const a2 = ((i2 == null ? void 0 : i2.async) ? [i2 == null ? void 0 : i2.conditions, ["node", "import"], ["node", "require"]] : [i2 == null ? void 0 : i2.conditions, ["node", "require"], ["node", "import"]]).filter(Boolean);
          for (const i3 of a2) {
            try {
          ...
          for (const r3 of e3.additionalExts) {
            ...
            if ((Wt.test(e3.filename) || Wt.test(((_a2 = e3.parentModule) == null ? void 0 : _a2.filename) || "") || qt.test(t3)) && (s2 = tryNativeRequireResolve(e3, t3.replace(qt, ".$1t$2"), n2, i2), s2)) return s2;
          }
          if (!(i2 == null ? void 0 : i2.try)) throw r2;
        }
        function tryNativeRequireResolve(e3, t3, i2, s2) {
          try {
            return e3.nativeRequire.resolve(t3, { ...s2, paths: [pathe_M_eThtNZ_dirname(fileURLToPath(i2)), ...(s2 == null ? void 0 : s2.paths) || []] });
          } catch {
          }
        }
        ...
        function jitiRequire(e3, t3, i2) {
          ...
          if (s2[r2]) return jitiInteropDefault(e3, (_a2 = s2[r2]) == null ? void 0 : _a2.exports);
...
`;
        ...
        function eval_evalModule(e3, t3, i2 = {}) {
          var _a2;
          const s2 = i2.id || (i2.filename ? basename(i2.filename) : `_jitiEval.${i2.ext || (i2.async ? "mjs" : "js")}`), r2 = i2.filename || jitiResolve(e3, s2, { async: i2.async }), n2 = i2.ext || extname(r2), a2 = i2.cache || e3.parentCache || {}, o2 = /\.[cm]?tsx?$/.test(n2), h2 = ".mjs" === n2 || ".js" === n2 && "module" === ((_a2 = (function(e4) {
            for (; e4 && "." !== e4 && "/" !== e4; ) {
          ...
          })(r2)) == null ? void 0 : _a2.type), c2 = ".cjs" === n2, p2 = i2.forceTranspile ?? (!c2 && !(h2 && i2.async) && (o2 || h2 || e3.isTransformRe.test(r2) || hasESMSyntax(t3))), l2 = Gt.performance.now();
          if (p2) {
...
//# sourceMappingURL=jiti-HMKA5FUY.js.map
